  ...
  render() {
    return (
          ...
          <div className="content">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <a
                  href="https://www.youtube.com/playlist?list=PLr6-GrHUlVf_ZNmuQSXdS197Oyr1L9sPB"
              ...
              <div className="card-deck">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">For Absolute Beginners content.</p>
                    <hr />
                    <a
                      className="btn btn-success"
                      href="https://www.youtube.com/watch?v=UB1O30fR-EE&feature=emb_title"
                      role="button"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <div className="card-body">
                    <div className="embed-responsive embed-responsive-16by9">
                      <iframe
                        ...
                        width={320}
                        height={215}
                        src="https://www.youtube.com/embed/MW4OXdzU2Mg"
                        frameBorder={0}
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    ...
                    <a
                      className="btn btn-success"
                      href="https://www.youtube.com/playlist?list=PLS1QulWo1RIbPrLaiosApdbbTwk-xMlIa"
                      role="button"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
      ...
      <!DOCTYPE html*/}
          ...
          <br />
          <a
            href="https://blog.teamtreehouse.com/23-essential-html-5-resources"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <br />
          <a
            href="https://www.youtube.com/watch?v=xE7VOZbHhFY"
            target="_blank"
            rel="noopener noreferrer"
          >
