        ...
        <div>
          <div className="card">
            ...
            <div className="card-body">
              ...
              <a
                href="https://www.youtube.com/playlist?list=PLr6-GrHUlVf96NLj3PQq-tmEB6woZjwEl"
          ...
          <h3>Videos</h3>
          <p>
            "JavaScript, often abbreviated as JS, is a high-level, just-in-time
            compiled, object-oriented programming language that conforms to the
            ECMAScript specification. JavaScript has curly-bracket syntax,
          ...
          <div className="container">
            <div className="card-deck">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Learn JavaScript in 1 Hour [2019].
                  </p>
                  <hr />
                  <a
                    className="btn btn-success"
                    href="https://www.youtube.com/watch?v=W6NZfCO5SIk&feature=emb_title"
                    role="button"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className="card-body">
                  <div className="embed-responsive embed-responsive-16by9">
                    <iframe
                      ...
                      width={320}
                      height={215}
                      src="https://www.youtube.com/embed/xpZLS6R91rQ"
                      frameBorder={0}
                      allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    />
                ...
                <div className="card-body">
                  <div className="embed-responsive embed-responsive-16by9">
                    <iframe
                      ...
                      width={320}
                      height={215}
                      src="https://www.youtube.com/embed/fGdd9qNwQdQ"
                      frameBorder={0}
                      allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    />
                  ...
                  <p className="card-text">
                    This Javascript Tutorial is designed for beginners.
                  </p>
                  <hr />
                  <a
                    className="btn btn-success"
                    href="https://www.youtube.com/playlist?list=PLoYCgNOIyGACnrXwo5HMCfOH9VT05znGv"
                    role="button"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
            ...
            <br />
            <a
              href="https://doc.qt.io/qt-5/qtqml-javascript-functionlist.html"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <br />
            <a
              href="https://medium.com/@dannyhuang_75970/8-best-places-to-learn-javascript-2018-updated-free-paid-940eed6b8296"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <br />
            <a
              href="https://scrimba.com/g/gintrotojavascript"
              rel="noopener noreferrer"
              target="_blank"
            >
              Introduction to JavaScript (Videos)
            </a>
            <hr />
            <h2>Books</h2>
            <a
