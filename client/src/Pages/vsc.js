        ...
        <div className="content">
          <div className="card">
            <div className="card-header" style={{textAlign: "center"}}>
              ...
              <img src="./images/VSLogo.png" className="titleimg" alt="vs code logo"/>
            </div>
            <div className="card-body">
              <h5 className="card-title">Quick Links</h5>
              <p className="card-text">You can find more info, documents and very detailed videos in the buttons below.</p>
              <a href="https://code.visualstudio.com/" className="btn btn-primary"  rel="noopener noreferrer" target="_blank">Go to VSC</a>
              <a href="https://code.visualstudio.com/docs" className="btn btn-success"  rel="noopener noreferrer" target="_blank">VSC Documents</a>
              <a href="https://www.youtube.com/watch?v=3FkWddODLno&list=PLGLfVvz_LVvTr9wMK6f9lTzOzSX6a6Pk-" className="btn btn-info"  rel="noopener noreferrer" target="_blank">VSC Videos</a>
            </div>
          </div>
          <br />
        ...
        <div className="container">
          <div className="card" style={{ width: '23rem' }}>
            <div className="card-body">
              ...
              <hr />
              <a className="btn btn-success" href="https://www.youtube.com/watch?v=u21W_tfPVrY" role="button"  rel="noopener noreferrer" target="_blank">Watch Video Here</a>
