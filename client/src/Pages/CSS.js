      ...
      <div className="mainBody">
        <div>
          <div className="content">
              ...
              <div className="card-deck">
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <a
                      className="btn btn-success"
                      href="https://www.youtube.com/watch?v=qKoajPPWpmo&list=PLr6-GrHUlVf8JIgLcu3sHigvQjTw_aC9C"
                      role="button"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <div className="card-body">
                    <div className="embed-responsive embed-responsive-16by9">
                      <iframe
                        ...
                        width={320}
                        height={215}
                        src="https://www.youtube.com/embed/I9XRrlOOazo"
                        frameBorder={0}
                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                    ...
                    <p className="card-text">
                      css tutorial for Beginners - Ninjas.
                    </p>
                    <hr />
                    <a
                      className="btn btn-success"
                      href="https://youtu.be/I9XRrlOOazo"
                      role="button"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <br />
            <a
              href="https://www.freecodecamp.org/learn/responsive-web-design/basic-css/"
              target="_blank"
              rel="noopener noreferrer"
            >
              freeCodeCamp
