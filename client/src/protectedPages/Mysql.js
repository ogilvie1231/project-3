      ...
      <div className="mainBody">
        <div>
          ...
          <p>
            ...
            company MySQL AB, which was bought by Sun Microsystems (now Oracle
            Corporation).[8] In 2010, when Oracle acquired Sun, Widenius forked
          ...
          <p>
            ...
            very, very good".[20] It has also been tested to be a "fast, stable
            and true multi-user, multi-threaded sql database server".
            <a href="https://en.wikipedia.org/wiki/MySQL">Wikipedia</a>
          </p>
          <iframe
            title="mysql"
            width={560}
                ...
                <div className="card-body">
                  <div className="embed-responsive embed-responsive-16by9">
                    <iframe
                      ...
                      width={320}
                      height={215}
                      src="https://www.youtube.com/embed/nN4Kjdverzs"
                      frameBorder={0}
                      allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    />
                  ...
                  <a
                    className="btn btn-success"
                    href="https://www.youtube.com/watch?v=nN4Kjdverzs&list=PL41lfR-6DnOokmJfmYj2hdVMKVGIcF7__"
                    role="button"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
